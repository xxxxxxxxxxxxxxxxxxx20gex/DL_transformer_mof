...
# 公司 4090  分支：sft-2
| 2 | hMOF_CO2_0.5 | 128 | 5e-5 | 30 | 是 | - | 0.514 | 相对位置编码 + adamw |
| 3 | hMOF_CO2_0.5 | 128 | 5e-5 | 30 | 是 | - | 0.503 | 相对位置编码 + 余弦退火 + adamw |
| 4 | hMOF_CO2_0.5 | 128 | 5e-5 | 30 | 是 | - | 0.614 | 相对位置编码 + 余弦退火 + adam |
| 12 | hMOF_CO2_0.5 | 128 | 5e-5 | 30 | 是 | - | 0.950 | 相对位置编码 + 余弦退火 + adamW +lora | lora效果很差，loss波动很大，调低学习率 |
| 13 | 问题 1：模型容量 vs 数据量不匹配  LoRA 可能不适合这个任务！ 原因：数据集可能较小  LoRA 的正则化效果不够  训练 loss 降太快，但泛化能力差 |
